"""
Gene-level CNV caller — version 01.
...
def call_gene_cnv(data, segments, gene, min_cn1_proportion, min_confidence, flank_padding):
...
def call_all_genes(data, segments, min_cn1_proportion, min_confidence, flank_padding):
