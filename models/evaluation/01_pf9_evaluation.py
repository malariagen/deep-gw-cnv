"""
Evaluation — version 01: compare gene calls against the Pf8 GATK ground truth.
...
already be doing better.

Reads from cfg:
    pf9_gt_path   — path to the Pf8/Pf9 curated-coverage TSV (required)
    pf9_meta_path — path to sample metadata TSV with a Population column
                    (optional; stratified-by-population table is omitted if absent)
"""
